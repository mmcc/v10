import { CameraRadioGroupCore, CameraRadioGroupDataAttrs, type CameraRadioGroupDevice } from '@videojs/core';
...
export class CameraRadioGroupElement extends MenuRadioGroupElement {
  ...
  readonly #options = new RadioOptionsController<CameraRadioGroupDevice & { disabled: boolean }>(this, {
