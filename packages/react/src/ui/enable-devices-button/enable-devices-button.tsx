...
export interface EnableDevicesButtonProps
  extends UIComponentProps<'button', EnableDevicesButtonCore.State>,
    EnableDevicesButtonCore.Props {}

/**
 * A button that enables the camera and microphone by selecting the camera
 * capture source, prompting for device permission as needed. Disabled while
 * capture is `acquiring`.
 */
