...
/**
 * A badge that reflects the publish session lifecycle ("Live",
 * "Connecting…", or "Offline"). Renders the translated session label when no
 * children are provided and exposes `data-publish-state` for styling.
 *
 * @example
 * ```tsx
 * <PublishBadge />
