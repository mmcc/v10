...
export interface ScreenShareButtonProps
  extends UIComponentProps<'button', ScreenShareButtonCore.State>, ScreenShareButtonCore.Props {}

/**
 * A button that toggles the capture source between the screen and the camera. Exposes `data-availability` so skins can
 * hide it where screen capture is unsupported (e.g. iOS Safari).
 */
