...
export const publishButton = cn(
  ...
  'data-[publish-state=live]:bg-(--publish-live-color) data-[publish-state=live]:text-white',
  ...
  'data-[publish-state=error]:bg-[oklch(from_var(--publish-live-color)_l_c_h/0.15)]',
  'data-[publish-state=error]:text-(--publish-live-color)'
);
...
export const publishStatus = cn(
  ...
  'bg-(--publish-status-background) [backdrop-filter:var(--surface-backdrop-filter)]',
  'shadow-[0_0_0_1px_var(--surface-outer-border-color),0_1px_3px_0_var(--surface-shadow-color),inset_0_1px_0_0_var(--surface-inner-border-color)]',
  'text-white'
);
...
export const connectionIndicator = cn(
  ...
  'data-[quality=good]:text-(--quality-good-color)',
  'data-[quality=fair]:text-(--quality-fair-color)',
  'data-[quality=poor]:text-(--quality-poor-color)'
);
